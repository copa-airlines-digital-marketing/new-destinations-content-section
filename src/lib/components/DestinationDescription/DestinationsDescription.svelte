...
<div class="grid w-auto grid-cols-2 container mx-auto  my-8">
    <div class=" font-suisse text-grey-600 m-4">
    ...
    <div class="grid grid-rows-[auto_1fr] rounded-2xl border border-solid border-gray-300">
       <div class="bg-primary  p-4 rounded-t-2xl">
        <h3 class="text-white font-gilroy ">Datos Importantes</h3>
       </div>
       <div class="container border border-solid border-gray-300 rounded-b-2xl">
        <h3>test</h3>
       </div>
    </div>
</div>
